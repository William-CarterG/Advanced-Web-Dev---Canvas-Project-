      ...
      <div className="max-w-sm mx-auto">
        <div className="mb-5">
          <div className="flex items-center">
            <div>
              <label htmlFor="colorSelected" className="block font-bold mb-1">Select {name} Color</label>
              <input
                id="colorSelected"
                type="text"
