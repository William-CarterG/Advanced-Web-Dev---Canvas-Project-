        ...
        <div className='flex flex-col justify-center h-[93vh] text-gray-600 rounded-xl border border-gray-200'>
          ...
          <div className="mx-auto w-2/3 my-10 h-24">
            {option === "active" && (
              <div>
                <SemiOpen/>
                <button className="py-4 px-8 mt-10 rounded-xl border-black border font-bold" onClick={() => setEvaluationData("active")}>Enviar</button>  
              </div>
            )}
            {option === "historical" && (
            <div>
              <SemiOpen/>
              <button className="py-4 px-8 mt-10 rounded-xl border-black border font-bold" onClick={() => setEvaluationData("historical")}>Enviar</button>  
            </div>
           )}
          </div>
        </div>
